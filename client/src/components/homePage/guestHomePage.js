  ...
  return (
    <div className="hv-100 d-flex flex-column justify-content-center">
      <div className="customCarousel d-flex mx-auto">
        <div className='customCarousel-item'>
          <img className='rounded-20' src={images[active - 1]} alt={images[active - 1].split("/")[images.length - 1]}/>
        </div>
        <div className='customCarousel-manage d-flex flex-column justify-content-between ml-2'>
          {active - 1 !== 0 ?
          ...
          <div className='customCarousel-pagination mx-auto d-flex flex-column justify-content-between '>
